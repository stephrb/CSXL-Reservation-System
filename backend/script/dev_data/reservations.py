...
res_1 =  Reservation(id=1,
                    start_time=datetime(2023, 3, 22, 12, 0, 0, 0),
                    end_time= datetime(2023, 3, 26, 15, 0, 0, 0))

res_2 =  Reservation(id=2, 
                     start_time=datetime(2023, 4, 3, 12, 0, 0, 0), 
                     end_time=datetime(2023, 4, 3, 14, 30, 0, 0)
                     )
...
res_4 = Reservation(id=4, 
                     start_time=datetime(2023, 4, 2, 9, 0, 0, 0), 
                     end_time=datetime(2023, 4, 2, 12, 0, 0, 0)
                     )
